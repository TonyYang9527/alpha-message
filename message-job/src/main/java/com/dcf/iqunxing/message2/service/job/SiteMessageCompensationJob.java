...
@Component
public class SiteMessageCompensationJob extends BaseMessageJob {
    ...
    protected Long initJobId() {
        return Constants.SITEMSG_CPST_JOB_ID;
    }
    ...
    public List<QueuePriorityVo> getQueuePriorityVos(final Date currentDate) {
        List<SiteMessage> result = siteMessageService.getLeaveMsg(currentDate, querySize);
