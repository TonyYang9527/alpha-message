...
@Component
public class PushCompensationJob extends BaseMessageJob {
    ...
    protected Long initJobId() {
        return Constants.PUSH_CPST_JOB_ID;
    }
    ...
    public List<QueuePriorityVo> getQueuePriorityVos(final Date currentDate) {
        List<PushMessage> result = pushService.getLeaveMsg(currentDate, querySize);
