...
@Component
public class SmsScheduleSendingJob extends BaseMessageJob {
    ...
    public List<QueuePriorityVo> getQueuePriorityVos(final Date currentDate) {
        List<SmsMessage> result = smsService.getTimedMsg(currentDate, querySize);
