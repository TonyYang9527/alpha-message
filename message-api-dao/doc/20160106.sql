...
#增加已处理时间
alter table site_message add processed_time datetime NULL AFTER `read_time`;
...
-- 站内信增加addition操作内容
update dcf_messages_new.site_message_template set addition = 'text=立即签约\r\n' where id = 8;
update dcf_messages_new.site_message_template set addition = 'text=查看合同\r\n' where id = 9;
update dcf_messages_new.site_message_template set addition = 'text=查看合同\r\n' where id = 10;
update dcf_messages_new.site_message_template set addition = 'text=查看合同\r\n' where id = 11;
update dcf_messages_new.site_message_template set addition = 'text=我要融资\r\n' where id = 12;
update dcf_messages_new.site_message_template set addition = 'text=我要融资\r\n' where id = 13;
update dcf_messages_new.site_message_template set addition = 'text=查看额度\r\n' where id = 17;
update dcf_messages_new.site_message_template set addition = 'text=我要还款\r\n' where id = 19;
update dcf_messages_new.site_message_template set addition = 'text=我要还款\r\n' where id = 20;
update dcf_messages_new.site_message_template set addition = 'text=我要还款\r\n' where id = 23;
update dcf_messages_new.site_message_template set addition = 'text=我要还款\r\n' where id = 24;
update dcf_messages_new.site_message_template set addition = 'text=我要还款\r\n' where id = 25;
update dcf_messages_new.site_message_template set addition = 'text=我要还款\r\n' where id = 26;
update dcf_messages_new.site_message_template set addition = 'text=我要还款\r\n' where id = 27;
update dcf_messages_new.site_message_template set addition = 'text=融资记录\r\n' where id = 28;
update dcf_messages_new.site_message_template set addition = 'text=查看账户\r\n' where id = 31;

update dcf_messages_new.site_message_content set addition = 'text=立即签约\r\n' where site_message_template_id = 8;
update dcf_messages_new.site_message_content set addition = 'text=查看合同\r\n' where site_message_template_id = 9;
update dcf_messages_new.site_message_content set addition = 'text=查看合同\r\n' where site_message_template_id = 10;
update dcf_messages_new.site_message_content set addition = 'text=查看合同\r\n' where site_message_template_id = 11;
update dcf_messages_new.site_message_content set addition = 'text=我要融资\r\n' where site_message_template_id = 12;
update dcf_messages_new.site_message_content set addition = 'text=我要融资\r\n' where site_message_template_id = 13;
update dcf_messages_new.site_message_content set addition = 'text=查看额度\r\n' where site_message_template_id = 17;
update dcf_messages_new.site_message_content set addition = 'text=我要还款\r\n' where site_message_template_id = 19;
update dcf_messages_new.site_message_content set addition = 'text=我要还款\r\n' where site_message_template_id = 20;
update dcf_messages_new.site_message_content set addition = 'text=我要还款\r\n' where site_message_template_id = 23;
update dcf_messages_new.site_message_content set addition = 'text=我要还款\r\n' where site_message_template_id = 24;
update dcf_messages_new.site_message_content set addition = 'text=我要还款\r\n' where site_message_template_id = 25;
update dcf_messages_new.site_message_content set addition = 'text=我要还款\r\n' where site_message_template_id = 26;
update dcf_messages_new.site_message_content set addition = 'text=我要还款\r\n' where site_message_template_id = 27;
update dcf_messages_new.site_message_content set addition = 'text=融资记录\r\n' where site_message_template_id = 28;
update dcf_messages_new.site_message_content set addition = 'text=查看账户\r\n' where site_message_template_id = 31;
